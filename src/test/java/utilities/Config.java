...
public class Config {
	...
	public static final String EXCEL = "C:\\Users\\senva\\newworkspace\\Bug_Busters_Team8_Duplicate\\Data Files\\APIHackathonData.xlsx";
	
	public static final String PostBatch_SUB_URL = "batches";

	public static final String GetAllBatch_SUB_URL = "batches";
